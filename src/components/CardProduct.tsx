...
const CardProduct = ({ data }: { data: any }) => {
  ...
  return (
    <Link
      to={url}
      className="border py-2 p-1  lg:p-4 grid gap-1 lg:gap-3 w-36 lg:min-w-52 rounded cursor-pointer bg-white"
    >
      ...
      <div className="flex items-center">
        <div className="hidden lg:block rounded text-sm w-fit p-[3.5px]  px-2 text-green-600 bg-green-50 ">
          10 min
        </div>
        <div>
